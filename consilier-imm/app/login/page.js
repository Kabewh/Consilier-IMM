        ...
        <section className="max-w-screen-xl h-[80vh] mx-auto flex justify-center items-center">
          <div className="h-[70vh] flex flex-col items-center justify-center border shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col w-[500px] h-2/4 space-y-4 mx-10 justify-center">
              ...
              />
              <button
                className="text-white text-bold text-lg p-2 bg-orange-800 shadow-lg rounded-md hover:bg-orange-900 transition mb-10 mt-5"
                disabled={loading} // Disable the button when loading
              >
                {loading ? "Se încarcă..." : "CONECTARE"} {/* Show loading text when loading */}
              </button>
              <div className="flex items-center justify-center">
                <p>
                  Nu ai cont?{" "}
                  <Link href={"/contact"} className="font-bold hover:text-blue-800">
                    Contacteaza-ne
                  </Link>{" "}
                  pentru a primi unul!
                </p>
